...
//		classifier.setNumFeatures(6);
	...
	public List<Double> classify(List<List<Integer>> datas) throws Exception {
		...
		String[] attributeNames = new String[] {
				"classInnerCount",
				"classOuterCount",
				"classInnerCount:maxInnerCount",
				"classInnerCount:aveInnerCount",
				"classOuterCount:maxOuterCount",
				"classOuterCount:aveOuterCount",
				"classType",
				"classIndex",
				"isCoreType1",
				"isCoreType2",
				...
				"classNum",
				"methodNum",
				"methodNum:methodsNum",
				"newMethodNum",
				"newMethodNum:newMethodsNum",
				"changeMethodNum",
				"changeMethodNum:changeMethodsNum",
				"deleteMethodNum",
				"deleteMethodNum:deleteMethodsNum",
				"methodsInnerCount",
				"methodsOuterCount",
				"statementNum",
				"statementNumWeight",
				"statementNum:maxStatementNum",
				"statementNum:aveStatementNum",
				"newStatementNum",
				"newStatementNum:newStatementsNum",
				"changeStatementNum",
				"changeStatementNum:changeStatementsNum",
				"deleteStatementNum",
				"deleteStatementNum:deleteStatementsNum",
				"class"
};
